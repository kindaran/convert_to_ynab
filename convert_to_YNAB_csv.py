...
def processSCFile(p_file):
    ...
    try:
        ...
        msg = str(e)
        logging.error(
            "*****Error in processSCFile. Current file: %s  Error: %s" % (file, msg))

# end processEQFile

def parseSCRow(p_row):
    global g_Delim
    ...
    try:
        ...
        msg = str(e)
        logging.error("*****Error in parseSCRow. p_row: %s Error: %s" % (p_row, msg))
        return None
