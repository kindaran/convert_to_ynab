...
def processTDFile(p_filelist):
    ...
    try:
        ...
        msg = str(e)
        logging.error("*****Error in processTDFile. p_filelist: %s  Current file: %s  Error: %s"%(p_filelist,file,msg))
...
def processEQFile(p_filelist):
    ...
    try:
        ...
        msg = str(e)
        logging.error("*****Error in processEQFile. p_filelist: %s  Current file: %s  Error: %s"%(p_filelist,file,msg))
...
if __name__ == '__main__':
    ...
    logging.debug("Command line arguments used: input_path: %s  output_path: %s  filetype: %s" %(g_InputPath,g_OutputPath,filetype))
    ...
    try:
        ...
        msg = str(e)
        logging.error("*****Error in Main. input path: %s  output path: %s  filetype: %s  Error: %s"%(g_InputPath,g_OutputPath,filetype,msg))
